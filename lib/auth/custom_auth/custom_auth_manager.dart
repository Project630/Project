...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    masarAuthUserSubject.add(
      MasarAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MasarAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MasarAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MasarAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    masarAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
